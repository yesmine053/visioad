...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50 pt-24 pb-20">
      ...
      {/* Floating particles — valeurs fixes pour éviter l'erreur d'hydratation Next.js */}
      {[
        { left: 8,  top: 12, dur: 2.4 }, { left: 22, top: 68, dur: 3.1 },
        { left: 35, top: 25, dur: 2.7 }, { left: 48, top: 82, dur: 3.5 },
        { left: 61, top: 15, dur: 2.2 }, { left: 74, top: 55, dur: 3.8 },
        { left: 85, top: 30, dur: 2.9 }, { left: 92, top: 75, dur: 3.3 },
        { left: 15, top: 90, dur: 2.6 }, { left: 55, top: 45, dur: 3.0 },
        { left: 70, top: 88, dur: 2.3 }, { left: 42, top: 60, dur: 3.6 },
      ].map((p, i) => (
        <motion.div
          key={i}
          className="absolute w-1 h-1 bg-primary/30 rounded-full"
          style={{ left: `${p.left}%`, top: `${p.top}%` }}
          animate={{ y: [0, -30, 0], opacity: [0.1, 0.8, 0.1], scale: [1, 1.5, 1] }}
          transition={{ duration: p.dur, repeat: Infinity, delay: i * 0.3 }}
        />
      ))}
